...
// // Token to verify (as an example, it should match the one generated if the same claims and key are used)
// const token = sJWT;  // Using the signed JWT instead of a hardcoded one
// const algorithm = "HS512";

// // Verifying the JWT
// console.log(
//     JSRSASign.jws.JWS.verifyJWT(token, key, { // Use the same key as used for signing
//         alg: [algorithm]
//     })
// );

// // Decoding and displaying the JWT parts
...
// console.log(pHeader); // Print parsed header
// console.log(pClaim);  // Print parsed claims
